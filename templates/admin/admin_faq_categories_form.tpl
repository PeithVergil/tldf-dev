...
<div class="help_text"><span class="help_title">{$lang.help}:</span>{$help.area_faq_category_edit}</div>
	{if $form.type=='edit'}
	...
	<table border=0 cellspacing=1 cellpadding=5>
		...
		<tr bgcolor=#FFFFFF>
			<td class="main_content_text" align="left" bgcolor="#FFFFFF" width="150">{$lang.descr_spr.status} <font class=main_error_text>*</font></td>
			<td><input type="checkbox" name="status" value="1" {if $form.status eq '1'}checked{/if}></td>
		</tr>
		{/if}
