				...
				<tr>
					...
					<table cellpadding="0" cellspacing="0">
						<tr>
							...
							<td style="padding-left: 5px;">
								<div>
								<input type=image id=smileLayer src="{$site_images_path}/img_smile.gif" onclick="return displaySmileLayer();">
								</div>
								...
								<table cellspacing=5 cellpadding=5 style="border: 1px solid #A5ACB2; background-color: #FFFFFF">
									<tr>
										<td><input type=image name=s1 src="{$site_images_path}/smiles/1.gif" onclick="displaySmileLayer();return insertBB(this.name)"></td>
										<td><input type=image name=s2 src="{$site_images_path}/smiles/2.gif" onclick="displaySmileLayer();return insertBB(this.name)"></td>
										<td><input type=image name=s3 src="{$site_images_path}/smiles/3.gif" onclick="displaySmileLayer();return insertBB(this.name)"></td>
										<td><input type=image name=s4 src="{$site_images_path}/smiles/4.gif" onclick="displaySmileLayer();return insertBB(this.name)"></td>
										<td><input type=image name=s5 src="{$site_images_path}/smiles/5.gif" onclick="displaySmileLayer();return insertBB(this.name)"></td>
									</tr>
									<tr>
										<td><input type=image name=s6 src="{$site_images_path}/smiles/6.gif" onclick="displaySmileLayer();return insertBB(this.name)"></td>
										<td><input type=image name=s7 src="{$site_images_path}/smiles/7.gif" onclick="displaySmileLayer();return insertBB(this.name)"></td>
										<td><input type=image name=s8 src="{$site_images_path}/smiles/8.gif" onclick="displaySmileLayer();return insertBB(this.name)"></td>
										<td><input type=image name=s9 src="{$site_images_path}/smiles/9.gif" onclick="displaySmileLayer();return insertBB(this.name)"></td>
										<td><input type=image name=s10 src="{$site_images_path}/smiles/10.gif" onclick="displaySmileLayer();return insertBB(this.name)"></td>
									</tr>
								</table>
							</div>
							</td>
...
<tr>
	...
	{if $par eq 'edit_post'}
		...
		<input type="hidden" value="{$data.first_post}" id="first_post" name="first_post">
		<input type="hidden" value="{$data.created_date}" id="created_date" name="created_date">
	{else}
	...
	<table cellpadding="0" cellspacing="0"  border="0">
		...
		<tr>
			...
			<td style="padding-top: 7px;">
				...
				<input type="button" value="{$lang.button.back}" onclick="document.location.href='{$file_name}?sel=subcategory&id_subcategory={$data.subcategory_id}';">
			</td>
		</tr>
	</table>
	</form>
