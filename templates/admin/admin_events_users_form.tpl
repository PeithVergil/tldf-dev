...
<font class=red_header>{$header.razdel_name}</font><font class=red_sub_header>&nbsp;|&nbsp;{$form.eventname}&nbsp;-&nbsp;{$header.event_users}</font><br><br>
				<table border=0 class="table_main" cellspacing=1 cellpadding=5 width="100%">
				<tr class="table_header">
					<td class="main_header_text" align="center"><b>&nbsp;</b></td>
					<td class="main_header_text" align="center" width="300"><b>{$header_group.all_users}</b></td>
					<td class="main_header_text" align="center" width="50"><b>&nbsp;</b></td>
					<td class="main_header_text" align="center" width="300"><b>{$header.event_users}</b></td>
					<td class="main_header_text" align="center"><b>&nbsp;</b></td>
				</tr>
				<tr bgcolor="#ffffff">
					<td class="main_header_text" align="center"><b>&nbsp;</b></td>
