...
{literal}
	function menuInit() {
        ...
        nodes[1] = new YAHOO.widget.MenuNode({label: "{/literal}{$lang.admin_menu.home}{literal}", icon: "{/literal}{$site_root}{$template_root}{literal}/images/menu/icons/home.gif", href: "{/literal}{$site_root}{literal}/admin/index.php"}, tree.getRoot(), false);
