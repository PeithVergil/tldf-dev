...
<font class=red_header>{$header.razdel_name}</font><font class=red_sub_header>&nbsp;|&nbsp;{if $form.par eq 'add'}{$header.add}{elseif $form.par eq 'edit'}{$header.edit}{/if}</font><br><br>
<div class="help_text"><span class="help_title">{$lang.help}:</span>{if $form.par eq 'edit'}{$help.club_save_category}{else}{$help.club_add_category}{/if}</div>
<div>
