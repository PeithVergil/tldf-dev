...
<td class="main_cell">
	...
	<tr>
		<td valign="top">
			<div class="header" style="margin: 0px; height: 25px;"><div style="padding: 5px 0px">{$lang.section.club_users} {$lang.club.in_category} {$club_name}</div></div>
		</td>
	</tr>
	<tr>
						...
						<tr valign="middle">
							...
							<td width="100%" class="text" valign="top">
									<div style="margin-top: 7px">
										...
										{if $item.club_leader eq 1}&nbsp;&nbsp;<font class="text_head">{$lang.club.club_leader}</font>{/if}
									</div>
						...
						<tr valign="top">
							...
							<td colspan=2 class="content_active">
								<div style="margin-top: 2px; margin-bottom: 2px">&nbsp;
									...
									{if ($use_pilot_module_giftshop) && ($item.gift_link)}<a href="{$item.gift_link}">{$button.gr_gift}</a>&nbsp;&nbsp;&nbsp;{/if}
									{/if}
									<a href="{$back_link}">{$lang.club.back_to_club}</a>
								</div>
							</td>
						</tr>
					</table>
