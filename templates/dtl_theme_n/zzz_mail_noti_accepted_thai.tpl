...
<div class="mail_content">
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
		...
		<tr>
			<td>
				<span class="mtext"><br>{$header.generic_t.hello} <b>{$data.fname}</b>,<br><br>
		...
		<tr>
			<td align="center">
				...
				<a href="{$data.fromlink}" target="_blank">{$header.generic_t.view_profile}</a><br><br>
			</td>
		</tr>
		<tr>
			<td>
				<span class="mtext">{$header.accepted_t.message_sub}<br><br><br>
		...
		<tr>
			<td>
				<div style="background:#cdecfb; margin-top:10px; padding:3px; text-align:center;">
					<span class="mtext" style="font-size:18px;">{$header.generic_t.what_next_head}</span>
				</div>
				<div style="padding:10px 0;">
					<span class="mtext">{$header.generic_t.what_next_text}</span>
					<div align="center">
					...
					<div style="background:#fcfbdf; margin:5px auto 0 auto; width:250px; padding:5px; text-align:center;">
						<span class="mtext">{$header.generic_t.your_login_is}: {$data.login}</span>
					</div>
				</div>
				<div style="background:#cdecfb; margin-top:10px; padding:3px; text-align:center;">
					<span class="mtext" style="font-size:18px;">{$header.generic_t.want_meet_head}</span>
				</div>
				<div style="padding:10px 0;">
					<span class="mtext">{$header.generic_t.want_meet_text}</span>
				</div>
			</td>
		</tr>
	</table>
