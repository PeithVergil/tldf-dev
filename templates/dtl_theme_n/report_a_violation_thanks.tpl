		...
		<a href="{$site_root}/contact.php"><img src="{$site_root}{$template_root}/images/Chat.png" alt="Chat With Me" title="Chat With Me" ></a>
         ...
         <div class="tcxf-ch-la chw-60-40">
             <div>
                 ...
                 <div class="_pleft20">
                     <div class="hdr2">{$lang.section.report_a_violation}</div>
								<div style="padding-bottom:7px;"><b>{$lang.report_a_violation.thanks_text_1}</b></div>
								<div style="padding-bottom:12px;line-height:17px;">{$lang.report_a_violation.thanks_text_2}</div>
