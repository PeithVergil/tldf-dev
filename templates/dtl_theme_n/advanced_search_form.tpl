...
<div class="toc page-simple"> {if $id_err == 1}
 ...
 {if $item.name_4}
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
      <tr>
        <td align="left" style="width:50%;" valign="top"><div class="content" style="padding:20px;">
            <div class="hdr2">{$lang.section.a_searchsave_header}</div>
            <div style="padding:8px 0px;">
              <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td valign="middle" align="left"><input type="text" name="search_name" value="{if $data.search_name==''}MyCustomSearch{/if}{$data.search_name}" style="width:165px" maxlength="100"></td>
                  <td valign="middle" style="padding-left:5px;"><p class="basic-btn_here"> <b>&nbsp;</b><span>
        ...
        <td align="left" valign="top"><div class="content" style="margin-top:10px; padding-bottom:10px;">
            <div class="hdr2">{$lang.section.a_searchload_header}</div>
            <div style="padding:8px 0px;">
              <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="left" valign="middle"><select class="index_select" name="load_id" style="width:165px;">
                      <option value="0">{$lang.home_page.select_default}</option>
                      
											{html_options values=$load_id output=$load_name}
										
                    </select></td>
                  <td valign="middle" style="padding-left:10px;"><p class="basic-btn_here"> <b>&nbsp;</b><span>
