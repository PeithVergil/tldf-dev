	...
	<tr>
		<td valign="top" class="text">
			...
			<tr>
				...
				<form name="club_form" id="club_form" action="club.php?sel=add" method="post" enctype="multipart/form-data">
					...
					<tr>
						...
						<td><input type="checkbox" name="open_join" value="1" checked></td>
					</tr>
					<tr>
						<td height="30" class="text_head">{$lang.club.hidden_club}:</td>
						<td><input type="checkbox" name="hidden_club" value="1"></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="text_head">{$lang.club.verification}:</td>
						<td><img src="{$form.kcaptcha}" alt="{$lang.club.verification}"><br><input type="text" style="width: 150px" name="keystring"></td>
					</tr>
					<tr>
