...
<div class="toc page-simple">
	...
	{/if}
	<div class="hdr2">{$lang.subsection.meet_them}</div>
	{if $form.err}
		<div class="error_msg">* {$form.err}</div>
	{/if}
	<div style="padding-bottom:10px;" class="det-14-2">{$header_s.toptext_meetthem.$user_gender} <a href="./myprofile.php?sel=edit_7">Here</a></div>
	{if $empty eq 1}
