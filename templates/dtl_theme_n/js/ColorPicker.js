// RS: used in organizer_home_management_table.tpl
...
function AnchorPosition_getPageOffsetLeft(el){
	var ol=parseInt(el.offsetLeft);
	while((el=el.offsetParent) != null){
		ol += parseInt(el.offsetLeft);
	}
	return ol;
}
...
function AnchorPosition_getPageOffsetTop(el){
	var ot=parseInt(el.offsetTop);
	while((el=el.offsetParent) != null){
		ot += parseInt(el.offsetTop);
	}
	return ot;
}
...
function ColorPicker(){
	...
	cp_contents += "<TABLE BORDER=0 BGCOLOR=#CCCCCC CELLSPACING=1 CELLPADDING=0>";
	...
	for(var i=0;i<total;i++){
		...
		cp_contents += '<TD BGCOLOR="#'+colors[i]+'"><FONT FACE="VERDANA" SIZE="-3"><A HREF="" onClick="'+windowRef+'ColorPicker_pickColor(\''+colors[i]+'\','+windowRef+'window.popupWindowObjects['+cp.index+']);return false;" '+mo+' STYLE="text-decoration:none;">&nbsp;&nbsp;&nbsp;</A></FONT></TD>';
	...
	if(document.getElementById){
		...
		cp_contents += "<TR><TD COLSPAN='"+width1+"' BGCOLOR='ffffff' ID='colorPickerSelectedColor'>&nbsp;</TD><TD BGCOLOR='ffffff' COLSPAN='"+width2+"' ALIGN='CENTER' ID='colorPickerSelectedColorValue'>FFFFFF</TD></TR>";
	}
	cp_contents += "</TABLE>";
	if(windowMode){
...
function pick(anchorname,elementname,fieldname) {
	table = document.getElementById(elementname);
