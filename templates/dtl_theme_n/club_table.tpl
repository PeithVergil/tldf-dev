...
<td class="main_cell">
	...
	<tr>
		<td valign="top">
			<div class="header" style="margin: 0px; height: 25px;"><div style="padding: 5px 0px">{$club.club_name}</div></div>
		</td>
	</tr>
	<tr>
				...
				<td valign="top" style="padding-left: 15px; padding-top: 15px;">
					...
					<tr>
						...
						{else}
							...
							<div style="padding-top: 3px;"><input type="button" value="{$lang.club.edit_club}" onclick="document.location.href='club.php?sel=edit_club&id_club={$club.id}'"></div>
							<div style="padding-top: 3px;">
								<div>
								<input type="button" value="{$lang.club.delete_club}" onclick="document.location.href='club.php?sel=delete_club&id_club={$club.id}'"><br><br>
								<input type="button" value="{$lang.club.change_club_icon}" onclick="ShowClubIconDiv();">
								</div>
								<div style="display: none;" id="club_icon_div">
									<div>
									<form action="club.php" method="POST" style="padding: 0px; margin: 0px;" enctype="multipart/form-data">
					...
					<tr>
						<td valign="top">
							...
							<form action="{$club.upload_link}" enctype="multipart/form-data" method="post">
							<table cellpadding="0" cellspacing="0">
								<tr>
								...
								<table cellpadding="0" cellspacing="0" border="0" width="100%">
									...
									<tr>
										<td style="padding-top: 5px;">
											...
											<a href="club.php?sel=delete_new&id={$club_news[n].id}">{$lang.button.delete}</a></span>
											{/if}
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td>
											<div style="display: none;" id="news_edit_div_{$club_news[n].id}">
												<form action="club.php" method="POST" style="padding: 10px 0px 10px 0px; margin: 0px;">
