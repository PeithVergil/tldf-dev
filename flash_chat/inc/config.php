<?php
	...
	$GLOBALS['fc_config'] = array(
		...
		'version'         => '4.7.11', //architecture release . feature release . patch release
		...
		'logoutWindowDisplayTime' => 1, // in seconds
		...
		//your CMS system
		'CMSsystem' => 'datingProCMS',// defaultCMS - default CMS, blank - stateless CMS
...
//		'defaultTheme' => 'spring_green',
		...
		'autologoutAfter' => 300,  //time of pooling inactivity after which user is considered logged off, seconds
		...
		'module' => array(
			...
			'float_x' => '300', // the default "x" position of the floating window (when anchor = -1)
 			...
 			'float_w' => '250', // the default width of the floating window (when anchor = -1)
