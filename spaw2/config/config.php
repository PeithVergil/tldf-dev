<?php
// RS: make it work with PHP 5.3 and 5.4
error_reporting(E_ALL & ~(E_NOTICE | E_STRICT | E_DEPRECATED));

// RS: for accessing $config
...
SpawConfig::setStaticConfigItem(
  ...
  array(
    array(
      'dir'     => $config['site_root'].'uploades/editor/', // ex: SpawConfig::getStaticConfigValue('SPAW_DIR').'uploads/flash/'
    ...
    array(
      'dir'     => $config['site_root'].'/uploades/editor/', // ex: SpawConfig::getStaticConfigValue('SPAW_DIR').'uploads/images/'
      'caption' => 'Images',
      'params'  => array(
    ...
    array(
      'dir'     => $config['site_root'].'/uploades/editor/', // ex: SpawConfig::getStaticConfigValue('SPAW_DIR').'uploads/files/'
      'fsdir'   => $config['site_path'].'/uploades/editor/', // optional absolute physical filesystem path, ex: SpawConfig::getStaticConfigValue('SPAW_ROOT').'uploads/files/'
      'caption' => 'Files', 
      'params'  => array(
...
#print $config['site_root'].'<br>';
#print SpawConfig::getStaticConfigValue('DOCUMENT_ROOT').'<br>';
#print $config['site_path'].'<br>';
?>
