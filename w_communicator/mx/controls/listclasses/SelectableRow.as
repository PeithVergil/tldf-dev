class mx.controls.listclasses.SelectableRow extends mx.core.UIComponent
{
    ...
    function setValue(itmObj, state)
    {
        ...
        if (_loc4 != undefined && itmObj != undefined)
        {
            ...
            _loc3._x = 2;
            _loc3._y = (_loc6 - _loc3._height) / 2;
        ...
        _loc2.setSize(__width - _loc9, Math.min(_loc6, _loc2.getPreferredHeight()));
        _loc2._y = (_loc6 - _loc2._height) / 2;
    } // End of the function
    function size(Void)
    {
    ...
    function setState(newState, transition)
    {
        ...
        if (!_loc3.enabled)
        {
            ...
            else
            {
                ...
                this.drawRowFill(_loc9, normalColor);
            } // end else if
        ...
        else
        {
            ...
            if (newState == "normal")
            {
                ...
                if (_loc8)
                {
                    ...
                    _loc2._y = 0;
                    bGTween = new mx.effects.Tween(this, _loc4 + 2, _loc4 * 2.000000E-001, _loc6, 5);
                }
                else
                {
                    _loc2._visible = false;
            ...
            else
            {
                ...
                if (_loc8)
                {
                    _loc2._height = _loc4 * 5.000000E-001;
                    _loc2._y = (_loc4 - _loc2._height) / 2;
                    bGTween = new mx.effects.Tween(this, _loc2._height, _loc4 + 2, _loc6, 5);
                    var _loc10 = _loc3.getStyle("selectionEasing");
                    if (_loc10 != undefined)
                    {
                        bGTween.easingEquation = _loc10;
                    } // end if
                }
                else
                {
