class mx.core.UIObject extends MovieClip
{
    ...
    function setSize(w, h, noEvent)
    {
        ...
        if (noEvent != true)
        {
            this.dispatchEvent({type: "resize", oldWidth: _loc3, oldHeight: _loc2});
        } // end if
    } // End of the function
    function size(Void)
    {
    ...
    function createClassObject(className, id, depth, initobj)
    {
        ...
        var _loc4 = (mx.core.UIObject)(this.createObject(className.symbolOwner.symbolName, id, depth, initobj));
        if (_loc3)
        {
