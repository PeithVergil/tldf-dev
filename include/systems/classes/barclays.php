...
/**
* Barclays payment system class
*
* @package DatingPro
* @subpackage Payment systems files
**/

class Payment_barclays extends Payment_Data_Kipper {
        ...
        */
        ...
        "product_name"  => "merchantdisplayname"
		...
		*/
        function Payment_barclays($mode, $debug) {
                $this->_debug = $debug;
		...
		*/
        function _initialization() {
                ...
                $this->_url = "https://secure2.epdq.co.uk/cgi-bin/CcxBarclaysEpdq.e";

                $this->_method = "POST";
                if ($this->_mode == PAYMENT_ENGINE_SEND) {
                        $this->makeRequired('seller_id', 'secret_word', 'order_id', 'amount', 'currency', 'return_url', 'type', 'epdqdata');
        ...
        function checkPayment() {
                ...
                if ($this->_mode == PAYMENT_ENGINE_RECEIVE) {
                        ...
                        if ($this->_verifyData()) {
                                ...
                                if ($_REQUEST["transactionstatus"] != "Success") {
