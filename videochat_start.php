...
flashvars.cameraFps				= 12; // 12
flashvars.cameraBandwidth		= 60000;
flashvars.cameraQuality			= 0;
flashvars.cameraKFrameInterval	= 48; // 48
...
var attributes = {};
attributes.id					= "VChat";
attributes.name					= "VChat";
attributes.align				= "middle";

swfobject.embedSWF("<?php echo $config['site_root']; ?>/pvchat/PVChat.swf", "flashContent", "637", "471", swfVersionStr, xiSwfUrlStr, flashvars, params, attributes);
...
<div>
	<?php
	$_SESSION['ga_event_code'] = 'webcamview';
	...
	<input type="hidden" name="_track_eventCode" id="_track_eventCode" value="webcamview" />
	-->
</div>
<!-- Google Analytics Tracking -->
<!--
...
<table>
	...
	<tr>
		<td><img src="<?php echo $config['site_root']; ?>/pvchat/banner.png" alt="" /></td>
		<td>
			<?php if (!IS_LIVE_SERVER) { ?>
			<script type="text/javascript">
			document.write(flashvars.address);
			if (flashvars.address == "50.116.69.235") {
				document.write(" Houston");
			} else if (flashvars.address == "54.249.239.153") {
				document.write(" Tokyo");
			} else if (flashvars.address == "54.251.116.204") {
